...
class Activity:
    ...
    def __init__(self, scenario, obj):
        ...
        self.timespan = utils.get_time(obj.get("持续时间"))   # 单位：秒
        self.total_frame = int(self.timespan * config_reader.fps)   # 根据当前活动的总时长，得到当前活动所需的视频帧数
    ...
    def to_video(self):
        ...
        # 先在背景图片上显示非action的角色 （这样的好处是action的角色可以覆盖这种角色）
